  ...
  return (
    ...
    <div id='ab'>
        <div id='full'>
          ...
          <p>Enter your personal details to use all of site<br></br> features</p><br></br>
...
<br></br><br></br>
<p>or use your email for reggisteration</p>
<form onSubmit={handleSubmit}>
<input type="text" className="form-control"   placeholder="Name" value={name} onChange={(e) =>setname(e.target.value)} required /><br></br>
<input type="text" className="form-control"   placeholder="Email" value={email} onChange={handleEmailChange} required />{!isValidEmail && (
...
const Register = () => {
  ...
  const handleSubmit = (event) => {
    ...
    // For example, you could send data to an API or perform authentication
  };
  ...
  return (
    <div className="container">
      ...
      <div className="slider">
        ...
        <div className={`slider-highlight ${isLogin ? 'login' : 'register'}`} />
      </div>
      <form onSubmit={handleSubmit} className={`form ${isLogin ? 'login' : 'register'}`}>
        <div>
